...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--targetSize', type=int, default=286, help='scale images to this size')
        ...
        self.parser.add_argument('--output_nc', type=int, default=20, help='# of output image channels')
        ################################
        # model specification
        ################################
        self.parser.add_argument('--loss', type=str, default='cross_ent',
