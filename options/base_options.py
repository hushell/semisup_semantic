...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--widthSize', type=int, default=256, help='then crop to this size')
        self.parser.add_argument('--heightSize', type=int, default=256, help='then crop to this size')
        ...
        self.parser.add_argument('--dataset_mode', type=str, default='unaligned', help='chooses how datasets are loaded. [unaligned | aligned | single | discrete]')
