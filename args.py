...
# data settings
################################
parser.add_argument('--dataset', type=str, default='m2nist', help='chooses which dataset is loaded. [cityscapesAB | pascal | camvid]')
...
parser.add_argument('--out-dir', default='./outputs', help='path where to save')
