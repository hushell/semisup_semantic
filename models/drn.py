...
class DRNSeg(nn.Module):
    def __init__(self, classes, model_name, gpu_ids=[], pretrained=True, use_torch_up=False):
        super(DRNSeg, self).__init__()
        self.gpu_ids = gpu_ids

        model = globals().get(model_name)(
            pretrained=pretrained, num_classes=1000) # load pretrained resnet from ImageNet
